...
void print_help()
{
  ...
  copyright_notice();
  printf("   usage: svm_python_learn [options] example_index_file model_file\n\n");
  printf("Arguments:\n");
  printf("         example_index_file -> index file to training data files\n");
  ...
  printf("\nMore details in:\n");
  printf("[1] Y. Yue, T. Finley, F. Radlinski, T. Joachims, A Support Vector Method for\n");
  printf("    Optimizing Average Precision, SIGIR, 2007\n");
  printf("[2] T. Joachims, A Support Vector Method for Multivariate Performance Measures,\n");
  printf("    ICML, 2005\n");
  printf("[3] T. Joachims, Learning to Align Sequences: A Maximum Margin Aproach.\n");
  printf("    Technical Report, September, 2003.\n");
  printf("[4] I. Tsochantaridis, T. Hofmann, T. Joachims, and Y. Altun, Support Vector \n");
  printf("    Learning for Interdependent and Structured Output Spaces, ICML, 2004.\n");
  printf("[5] T. Joachims, Making Large-Scale SVM Learning Practical. Advances in\n");
  printf("    Kernel Methods - Support Vector Learning, B. Schölkopf and C. Burges and\n");
  printf("    A. Smola (ed.), MIT Press, 1999.\n");
  printf("[6] T. Joachims, Learning to Classify Text Using Support Vector\n");
